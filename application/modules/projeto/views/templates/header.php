	...
	<div class="navbar navbar-top navbar-inverse">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="<?php echo base_url();?>" style="float:left;">Projeto
				</a>
				...
				<div class="nav-collapse nav-collapse-top collapse">
	            	<ul class="nav pull-right">
	                    ...
	                    <ul class="dropdown-menu">
	                    	<li class="with-image">
	                            <div class="avatar">
	                                <img src="<?php echo base_url();?>public/images/icons_big/account.png" class="avatar-medium"/>
	                            </div>
	                            <span><?php echo $user_data['nome'];?></span>
	                        </li>
	                    	<li class="divider"></li>
							<li><a href="<?php echo base_url();?>projeto/manage_profile">
