                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo base_url() ?>coordenacao/patrimonio"><i class="menu-icon icon-list"></i>Patrimônio<b class="label green pull-right">
                                    0</b> </a></li>
...
require_once(APPPATH."modules/coordenacao/views/".$content.".php");
