...
<head>
    <head>
        ...
        <title>Edmin</title>
        <link type="text/css" href="<?php echo base_url();  ?>public/temas/admin/bootstrap/css/bootstrap.min.css" rel="stylesheet">
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.html">CIMOL </a>
